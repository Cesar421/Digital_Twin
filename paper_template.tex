...
\subsection{Climate change and built heritage}
...
\subsection{The Jakobsplan building in Weimar}
...
\subsection{Structural health monitoring and digital twins}
...
\begin{figure}[H]
  \begin{center}
    \begin{subfigure}[t]{1.05\textwidth}
        ...
        \caption{Overall conceptual framework: from physical asset to Digital Twin methodology approach 1.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{1.05\textwidth}
        \centering
    ...
    %\end{subfigure}
    \caption{Methodological Approach 1 and 2 --- Digital Twin framework
    for wind load assessment of GDR-era heritage buildings.}
    \label{fig:method1}
  \end{center}
\end{figure}
...
\subsection{Sensor node design and assembly}
...
\subsection{Sensor placement in the Jakobsplan building}
\label{sec:placement}
...
\subsection{In-situ sensor deployment}

[To be completed.]


\subsection{Identified natural frequencies}
