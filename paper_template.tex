...
reinforced-concrete \textit{(RC)} panel buildings known as
...
in Weimar, Thuringia, Germany (Figure~\ref{fig:jakobsplant_building}). The main
...
\noindent Given their age of over 50 years, the Jakobsplan blocks have reached
or are nearing the end of their originally intended service life. Coupled with the increasing wind-load demands projected under
...
can deliver scientifically sound data quality.
